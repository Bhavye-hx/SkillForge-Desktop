...
function createWindow() {
  ...
  ipcMain.handle('google-sign-in', async () => {
    return new Promise((resolve, reject) => {
      ...
      const clientId = '246800623841-iqrjmk0top8gi8tbp363v4pimoqvqndj.apps.googleusercontent.com';
      const redirectUri = 'https://skillforge-1c07c.firebaseapp.com/__/auth/handler';
